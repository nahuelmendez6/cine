...
SECRET_KEY = 'django-insecure--+f$$nbrm7oc7wd+=gsm*@dutb+wv^0g_r%*4(mx*7gkcfaguf'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'nahum8798@gmail.com'
EMAIL_HOST_PASSWORD = ''
DEFAULT_FROM_EMAIL = 'CineApp <nahum8798@gmail.com'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CineApp API',
    'DESCRIPTION': 'API sistema de gestión de cines',
    'VERSION': '1.0.0',
